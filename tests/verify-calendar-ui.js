...
includes('--color-bg-grad-2: #312e81', 'purple glass palette');
...
includes('@media (max-width: 819px)', 'mobile-only layout rules');
includes('"calendar"', 'mobile calendar first area');
includes('"mission"', 'mobile mission second area');
includes('.calendar-preview {\n        display: none;', 'mobile hides next month preview');
